...
class Main extends Component {
    ...
    submitstep2 = e =>{
        console.log('form submitted!....',this.state,1048);
        e.preventDefault();
        // return false;
        var maunfacturer_type = $('input[name=manufacturerType]:checked').val();
        console.log(maunfacturer_type,1084);
        if(this.state.id != '' && this.state.value != ''){
            try{
                Axios.post(
                    ApiUrl + "/common/update_categories_seller.php",
                    {  
                        sellerid: window.localStorage.getItem("log_id"),
                                                                                                ...
                                                                                                : (this.state.step2) ? (
                                                                                                    <form onSubmit={this.submitstep2} className="col px-0">
                                                                                                        ...
                                                                                                        <div className="col-md-12 my-2 px-0">
                                                                                                            ...
                                                                                                            <div className="form-group text-center">
                                                                                                            <div className="mb-1 text-left">I am Manufacturer :</div>
                                                                                                            <div className="form-check form-check-inline">
                                                                                                                <input
                                                                                                                    className="form-check-input"
                                                                                                                    type="radio"
                                                                                                                    name="manufacturerType" value="1"
                                                                                                                    id="manufacturer_yes" required
                                                                                                                />
                                                                                                            ...
                                                                                                            <div className="form-check form-check-inline">
                                                                                                                <input
                                                                                                                    className="form-check-input"
                                                                                                                    type="radio"
                                                                                                                    name="manufacturerType" value="0"
                                                                                                                    id="manufacturer_no" checked required
                                                                                                                />
                                                                                                        ...
                                                                                                        <div className="col-md-12 my-2 text-center">
                                                                                                            <button className="btn btn-solid">Go</button>
                                                                                                        </div>
                                                                                                </form>
                                                                                                ) :
                                                                                                ''
