...
class Main extends Component {
    ...
    componentDidUpdate(prevProps, nextProps) {
        ...
        if (this.props.chatToSeller.chatWithSupplier && !this.state.chatWithSupplier && !prevProps.chatToSeller.chatWithSupplier) {
            // console.log(this.props, 'Update-1', this.props)
            this.setState({
