...
//  console.log('componentDidUpdate', nextProps, this.props, this.state.cartItems);
...
//  console.log('shipping cost', val)
 ...
 getTotalCartValue(this.state.totalShippingCost, this.state.totalProductCost).then(
 async val => {
