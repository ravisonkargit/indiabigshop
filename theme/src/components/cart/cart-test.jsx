    ...
    if (this.state.shippingCountry != getCookie("countryid")) {
      ...
      axios
        .post(
          ...
          `${types.ApiUrl}/common/update_country_cart_test.php`,
          {
    ...
    if (this.state.symbol != getCookie("currency")) {
      ...
      axios
        .post(
          ...
          `${types.ApiUrl}/common/update_currency_cart_test.php`,
          {
            sellerid: ls.get("log_id"),
            plateform_type: "",
            security_token: "",
        ...
        .then(async (response) => {
          if (response.data.statusId == "1") {
            ...
            this.deactivateLoader();
            console.log(response.data.result.cart, 170);
          } else {
            console.log("error occured");
            await this.setState({
              cartItems: null,
  ...
  updateCart = async () => {
    ...
    axios
      .post(
        ...
        `${types.ApiUrl}/common/receive_cart_test.php`,
        {
          sellerid: ls.get("log_id"),
          plateform_type: "",
          security_token: "",
                        ...
                        Array.isArray(item) ? (
                          <tbody className="">
                              <tr>
                                ...
                                <a
                                    target="_blank"
                                    href={`http://localhost:3000/product/plain-tshirts-silver-343538.html`}
                                  >
                                    <img
                                      src={`https://img.beldara.com/product_images_thumb/4449192CSU9BXUJ0-Beldara-.jpg`}
                                      alt={`Plain Tshirts silver  on Beldara.com`}
                                    />
                                  </a>
                                </td>
                          <td className=""> 
                          ...
                          item.map((eachsub, j) => (
                            ...
                            <tr className={isMobile ? "d-flex" : ""}>
                              <td className={isMobile ? "d-block" : ""}>
                                <a
                                  target="_blank"
                                  href={`${process.env.PUBLIC_URL}/product/${eachsub.url}.html`}
                                >
                                  <img
                                    src={`${imgUrl}/product_images_thumb/${eachsub.img}`}
                                    alt={`${eachsub.name} on Beldara.com`}
                                  />
                                </a>
                                ...
                                <div className="text-dark">
                                  ...
                                  <span className="h5 text-dark text-capitalize">
                                    {eachsub.sellerCountry
                                      ? eachsub.sellerCountry
                                      : "India"}
                                  </span>
                                </div>
                                {eachsub.offer_stock == 0 ? (
                                          ...
                                          <span className="input-group-prepend">
                                            <button
                                              ...
                                              onClick={this.decreaseOneQty.bind(
                                                ...
                                                eachsub.eachprice,
                                                eachsub.offer_price,
                                                eachsub.offer_from_date,
                                                eachsub.offer_to_date,
                                                eachsub.offer_min_qty,
                                                eachsub.offer_mrp_price,
                                                eachsub.offer_currency,
                                                eachsub.offer_unit,
                                                eachsub.offer_stock
                                              )}
                                              data-type="minus"
                                  ...
                                  <div>
                                    ...
                                    {this.state.validation ? (
                                      <div
                                        ...
                                        id={`validate_` + eachsub.cartitemid}
                                      >
                            ...
                            <div className="row my-3 align-items-center">
                              ...
                              <div className="col-md-3">
                                ...
                                parseInt(1) ? (
                                  ...
                                  <div className="text-left">
                                    {" "}
                                    Select Shipping Country to check Shipping
                                    Cost{" "}
                                  </div>
                                )}
                              </div>
