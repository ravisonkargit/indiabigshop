...
class cartComponent extends Component {
  ...
  handleChange = async (e) => {
    ...
    if (
      ...
      if(this.state.render_total_static == 0){
        if(this.state.symbol == 'USD'){
          if(new_valuable_amount > 0 && this.state.totalCartValue > new_valuable_amount){
            var new_amount = 
            parseFloat(this.state.totalCartValue - new_valuable_amount).toFixed(2)
          }else if(new_valuable_amount > 0 && this.state.totalCartValue < new_valuable_amount){
            var amount_to_be_cut = this.state.totalCartValue/2;
            var new_amount = 
            ...
            //      parseFloat(this.state.totalCartValue - new_valuable_amount).toFixed(2)
             ...
             if(this.state.wallet_amount > 0 &&  this.state.totalCartValue > this.state.wallet_amount){
              var new_amount = parseFloat(
                this.state.totalCartValue - this.state.wallet_amount
              ).toFixed(2);
             }else if(this.state.wallet_amount > 0 &&  this.state.totalCartValue < this.state.wallet_amount){
               var new_amount_to_cut = this.state.totalCartValue/2;
              var new_amount = parseFloat(
        ...
        if(this.state.symbol == 'USD'){
          if(this.state.wallet_usd_amount > 0 && this.state.totalCartValue > this.state.wallet_usd_amount){
            var new_amount = 
            parseFloat(this.state.totalCartValue - this.state.wallet_usd_amount).toFixed(2)
          }else if(this.state.wallet_usd_amount > 0 && this.state.totalCartValue < this.state.wallet_usd_amount){
            var amount_to_be_cut = this.state.totalCartValue/2;
            var new_amount = 
            parseFloat(this.state.totalCartValue - amount_to_be_cut).toFixed(2)
          }
                    ...
                    this.state.wallet_amount != "0.00" ? 
                      ...
                      <div className="d-flex align-items-center 1">
                        ...
                        <div className="text-left h6">
                          ...
                          >
                            {`Use wallet Amount (${parseFloat(this.state.wallet_usd_amount).toFixed(2)})`}
                          </label>
                        </div>
                      </div>
                      ...
                      <div className="d-flex align-items-center 2">
                        ...
                        <div className="text-left h6">
                          ...
                          <label
                            ...
                            for="wallet_amount_check"
                          >
                            {`Use wallet Amount (${parseFloat(this.state.wallet_amount).toFixed(2)})`}
                          </label>
                        </div>
                      </div>
                     : ''
