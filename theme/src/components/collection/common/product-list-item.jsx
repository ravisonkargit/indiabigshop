...
import { getChatWithSupplier,getCartLength } from "../../../actions/index";
        ...
        <div className="product-box bg-light ">
          ...
          <div className="product_info">
            <div>
              ...
              this.offerExist(
                product.offer_from_date,
                product.offer_to_date
              ) ? (
                <div>
                  <span className="d-flex">
                    <del className="mr-1">
                      ...
                      <PriceCalcOffer
                        ...
                        price_offer={this.CalcOfferPrice(
                          product.mrp_price,
                          product.offer_min_qty,
                          product.offer_stock,
                          product.offer_min_qty,
                          product.offer_from_date,
                          product.offer_to_date
          ...
          <div className="row mb-2 mx-0">
            ...
            !this.offerExist(product.offer_from_date, product.offer_to_date) ? (
              <React.Fragment>
                <div
                  id={`btn_${product.id}`}
                  className=" col-12 col-md-12 col-sm-12 text-center py-2 px-1 buy1"
                >
                  <div
              ...
              <React.Fragment>
                <div
                  id={`btn_${product.id}`}
                  className=" col-6 col-md-6 col-sm-6 text-left py-2 px-1 buy2"
                >
                  <div
                    className="mouse_pointer btn btn_Pro  btn-orange"
                    id={product.id}
...
export default withRouter(
  withTranslate(connect(mapStateToProps,{getCartLength})(ProductListItem))
);
