...
import {getVisibleproducts, getSearchProducts} from '../../../services';
        ...
        return (
            <div className="product-filter-content">
                <div className="search-count">
                    <h5>{translate('Showing products')} 1-{this.props.totalCount} {translate('Result')}</h5>
                </div>
                ...
                <div className="product-page-filter d-none">
