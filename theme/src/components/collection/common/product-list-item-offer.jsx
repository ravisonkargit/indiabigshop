...
class ProductListItemOffer extends Component {
  ...
  async goToExpressCheckout(pid, qty, product_currency, sellerid,amount) {
    // var each_product_price = this.state.price;
    var each_product_price = amount;
    if (
  ...
  createCart(
    ...
    axios
      ...
      .then((response) => {
        // console.log(productid,qty,product_currency,product_sellerid,amount,'createCart');
      ...
      <React.Fragment>
        ...
        <div className="badge badge-danger text-wrap my-1 p-3" style={offer_tag}>
                ...
                <div className="">
                  <div className="d-flex">
                    ...
                    <del>
                      ...
                      /> */}
                      {this.props.symbol+' '+product.mrp_price}
                    </del>
                  </div>
                  <b>
                    {/* <PriceCalcOffer
                    ...
                    /> */}
                    {this.props.symbol+' '+product.eachprice}
          ...
          <div className="row mb-2 mx-0 my-4">
            {product.start_price &&
            parseFloat(product.start_price) > parseFloat(0) && product.offer_stock > 0 ? (
              <React.Fragment>
                {
                  ...
                  ? 
                    ...
                    >
                      {/* <div
                        ...
                        onClick={this.validate.bind(
                          ...
                          product.id,
                          product.min_qty,
                          parseFloat(product.eachprice) * parseInt(product.min_qty),
                          this.props.symbol,
                          product.price_offer,
                          product.currency,
                          product.sellerid
                    ...
                    <img
                      ...
                      src="https://img.beldara.com/images/buy_now_btn.png"
                      id={product.id}
                        onClick={this.validate.bind(
                          this,
                          "buyBtn",
                ...
                <div className="col-5  text-center col-md-5 col-sm-5 py-2 px-1">
                  <div id={`div_${product.id}`}>
                    ...
                    </Link> */}
                    {
                      ...
                      <img 
                        className="mouse_pointer"
                        src="https://img.beldara.com/images/chat_now_btn.png"
                        onClick={this.chatBtn.bind(this,product)}
                      />
                      : ''
                    }
