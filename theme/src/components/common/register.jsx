...
class Register extends Component {
        ...
        // $(".regBtn").val('Please wait...').prop('disabled', true);
            ...
            //   response.data.result; 
              ...
              if (response.data.status === 'Failed') {
                ...
                axios.post(`${CentralUrl}/bbapi/common_leads.php`,
                {
              ...
              $(".regBtn").val('Submit').prop('disabled', false);
            ...
            this.forceUpdate();
            $(".regBtn").val('Please wait...').prop('disabled', false);
    ...
    otpSubmit = (e) => {
        ...
        e.preventDefault()
        $(".errOtp").addClass('d-none').removeClass('d-block alert alert-danger')
        if (this.validator.allValid()) {
                axios.post(
              ...
              .then(response => {
                  if(response.data.status === "Failed") {
                    $(".errOtp").html(response.data.message).addClass('d-block alert alert-danger').removeClass('d-none')
    ...
    redirect_to_start_order = () =>{
      console.log('redirect_to_start_order', this.state.link)
                ...
                <div className="body" >
                 ...
                 <div className="form-signin" >
                    ...
                    <div className="form-label-group">
                        <input type="text" id="name" className="form-control" placeholder="Full name" required="" autoComplete="off" name="name" onChange={this.setStateFromInput} />
                    ...
                    <div className="form-label-group">
                        <input type="email" id="inputEmail" className="form-control" placeholder="Email address" required="" autoComplete="off" name="email" onChange={this.setStateFromInput} />
                    ...
                    <div className="form-label-group">
                        <input type="password" id="inputPassword" className="form-control" placeholder="Create your Password" autoComplete="off" required="" name="pass" onChange={this.setStateFromInput}/>
                        ...
                        <p className="text-dark"><i className="fa fa-info rounded"></i> <small>We will send you a text to verify your phone. </small></p>
                        <div className="form-group text-center">
                    
                            <button className="btn btn-lg btn-primary btn-block text-capitalize regBtn" style={{ backgroundColor: '#f5821f', border: '1px solid #f5821f' }} type="submit">Create my account</button>
                            
                        </div>
                    
                    <div className="a-divider a-divider-break"><h5>Already have Beldara account?</h5></div>
                        <p>
                            <div className="form-group text-center">
                                ...
                                <span className="btn btn-lg btn-primary btn-block text-capitalize mouse_pointer"  onClick={() => this.gotoLogin()} style={{backgroundColor:'#00aeef',border:'1px solid #00aeef'}} type="">Sign In</span>
                            </div>
...
Verification code has been sent to your mobile no. email, {this.state.email}, please enter the same here to complete the signup.

                    </p>
                    <p className="errOtp d-none"></p>
                    <form onSubmit={this.otpSubmit}>
                    <div className="form-label-group">
                        <input type="tel" id="otp" className="form-control" placeholder="Enter your OTP" required="" autoComplete="off" name="otp" onChange={this.setStateFromInput} />
                    ...
                    <button className="btn btn-lg btn-primary rounded-1  text-capitalize" style={{ backgroundColor: '#f5821f', border: '1px solid #f5821f' }} type="submit">Confirm My OTP</button>
                                                {/* <span className="btn btn-lg btn-secondary rounded-1 ml-3 text-capitalize" onClick={this.skipOtp}>Skip</span> */}
                    </div>
                    </form>
                    </Suspense>
                    </React.Fragment>
