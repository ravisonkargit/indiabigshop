                ...
                <div className="card">
                  ...
                  >
                    <h2 className="mb-0 justify-content-end">
                      ...
                      {/* <i className="fa fa-comment" aria-hidden="true" style={{ color: "#fff" }}></i> */}
                    </h2>
                  </div>
                          ...
                          >
                            <div className="card-body">
                              <div className="text-center">
                                ...
                                ></i>{" "}
                                <a
                                  href="https://api.whatsapp.com/send?phone=+1-913-289-0433&text=Hi,%20I%20was%20looking%20on%20your%20website"
                                  target="_blank"
                                >
