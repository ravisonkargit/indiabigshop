...
class LandingPage extends Component {
    ...
    componentDidMount() {
        try {
            ...
            axios.post("https://api.beldara.com/common/get_new_arrival.php",{type:this.props.match.params.type,cat_id:query1[0],security_token:'',plateform_type:''}, {headers: {'Content-Type': 'multipart/form-data'}})
