...
class Category extends Component {
    constructor(){
        super();
        url_path = window.location.pathname.split('/supplier/')[1].split('.html')[0].split('/');
    }
    state = {
        layoutColumns: 3,
        query: '',
        ...
        return (
            <React.Fragment>
                ...
                <div className="breadcrumb-section py-1">
                        <Helmet>
                            <title>{`${this.state.catTitle} | beldara.com`}   </title>
                            <meta name="description" content={`${this.state.metaDesc} | beldara.com`} />
                        ...
                        <div className="row">
                            ...
                            <nav aria-label="breadcrumb" className="theme-breadcrumb">
                                ...
                                {url_path[0] ? (
                                    ...
                                    <Link to={`${process.env.PUBLIC_URL}/cat/${url_path[0]}.html`}>
                                        {url_path[0]}
                                    </Link>
                                    </li>
                                ) : ""}
                                {url_path[1] ? (
                                    ...
                                    <Link to={`${process.env.PUBLIC_URL}/cat/${url_path[0]}/${url_path[1]}.html`}>
                                       {url_path[1]}
                                    </Link>
                                    </li>
                                ) : ""}
                                {url_path[2] ? (
                                    <li className="breadcrumb-item small" aria-current="page">
                                    <Link to={`${process.env.PUBLIC_URL}/cat/${url_path[0]}/${url_path[1]}/${url_path[2]}.html`}>
                                       {url_path[2]}
                                    </Link>
                                    </li>
                                ) : 
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="top-banner-wrapper text-center">
                                                        {this.state.catBanner ?
                                                            <a href="#">
                                                                <img src={`${this.state.catBanner}`}
                                                                className="img-fluid" alt={this.state.catName} />
                                                            </a>
                                                            : ''}
