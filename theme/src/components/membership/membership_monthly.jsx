...
class MembershipMonthly extends Component {
 constructor(props) {
 super(props);
 this.state = {
 amount1: 2950,
...
amount4: "39.99",
 ...
 When you can shell out upwards of 20K-50K INR for a shop/office, 2950 INR (39.99 USD) is but a small price to pay for a global, online store that’s open 24/7.
 </p>
 <u>Features:</u>
...
export default withTranslate(connect(mapStateToProps)(MembershipMonthly));