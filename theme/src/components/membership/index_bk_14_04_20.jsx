...
// amount4: "39.99",
 ...
 componentDidUpdate(previousProps) {
  ...
  //   $('#lead_payment2').find('[class="razorpay-payment-button"]').click();  
  //   var ele = $('#'+this.state.element).find('[class="razorpay-payment-button"]').length;
  //   // console.log(this.state.element,388,ele);
  //   if(ele == '1'){
  //     $('#'+this.state.element).find('[class="razorpay-payment-button"]').click();
  //   }
  // }
 currency = this.props.data.symbol;
...
//  console.log($('#lead_payment2').find('[class="razorpay-payment-button"]').length,381);
//  $('#lead_payment2').find('[class="razorpay-payment-button"]').click();
