...
class DetailsTopTabs extends Component {
  componentDidMount = () => {
    $(".desc_content")
      .find("li")
      .addClass("desc_contentli");
    $(".desc_content")
      .find("ul")
      .addClass("desc_contentul");
    $(".desc_content")
      .find("td")
  ...
  updateClass = () => {
    $(".desc_content")
      .find("li")
      .removeClass("desc_contentli")
      .addClass("desc_contentli");
    $(".desc_content")
      .find("ul")
      .removeClass("desc_contentul")
      .addClass("desc_contentul");
  };
  ...
  render() {
    ...
    return (
      <section className="tab-product m-0" id="prodDetailSpec">
            ...
            <Tabs className="tab-content nav-material">
              ...
              {item.description ? (
                <TabPanel className="desc_content tab-pane fade mt-4 show active">
                  <p
                    className="desc_content mt-4 p-0"
                    ...
                    <tbody>
                      {item.feature.map((vari, index) => (
                        <React.Fragment key={index}>
                          {vari.feature ? (
                            <tr>
                              <td className="small border-bottom">
                                {vari.feature}
                              </td>
                            </tr>
                          ) : (
        ...
        <div>
          {item.attribute ? (
            <h4 className="float-left" style={{ fontSize: "20px" }}>
        ...
        {item.desc1 ? (
          <div className="my-3">
            <div>
              ...
              <p
                className="p-0 border p-3"
                dangerouslySetInnerHTML={{ __html: item.desc1 }}
                style={{ borderRadius: "5px", lineHeight: "20px" }}
              ></p>
            </div>
          </div>
        ) : (
