    ...
    return (
      <div className="col-lg-8">
        ...
        <div className="product-right product-description-box">
          ...
          <div className="row d-flex justify-content-end align-items-center mt-2">
            {this.state.product_mrp !== null &&
            this.state.selling_price !== null ? (
              <div className="float-left col-sm-7">
                <div className="row">
            ...
            {this.state.gst_val != null ? (
              <div
                id="prices_cards"
                className="bg-grey float-right col-sm-5 productBorder"
              >
