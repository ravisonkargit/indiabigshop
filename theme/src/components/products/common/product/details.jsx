...
class Details extends Component {
  ...
  //   // console.log('componentWillReceiveProps', nextProps, this.props,348);
  //   this.loadedproduct();
  // }
  ...
  getProdDetails = async (currency, country_code) => {
          ...
          {item.price.length > 0 ? (
            <div className="timer border-product w-100 p-0 m-auto text-center">
              <div id="demo" className=" py-2 ">
                ...
                this.offerExist(item.offer_from_date, item.offer_to_date) ? (
                    ...
                    <div className="time-cal">
                      ...
                      <div className="d-flex justify-content-center">
                        ...
                        {this.state.offer_price > 0
                          ? `${
                              this.state.currency
                            } ${this.state.offer_price.replace(
                              /\B(?=(\d{3})+(?!\d))/g,
                              ","
                            )}`
                          : "Ask for price"}
                        ...
                        <div class="timer-cal">
                          <div>
                            <div class="font-weight-bold">
                              {vari.eachunit > 0
                                ? `${vari.currency}-${new Intl.NumberFormat().format(
                                  vari.eachunit
                                  )}`
                                : "Ask for price"}
                              {}
            ...
            >
              <div className="d-flex align-items-center">
                ...
                <div className="mx-2">
                  <Share
                    productName={
                      item_name ? item_name.replace(/[^a-zA-Z ]/g, "") : ""
                    }
                    url={window.location}
                  />
                </div>
                      ...
                      <div>
                        <div className="font-weight-bold">
                          {this.state.price > 0 ? (
                            <>
                              <div
                                className="spinner-border spinner-border-sm common_class_for_spin mr-1 d-none"
                                role="status"
                                style={{ color: "#f1aa61" }}
                              >
