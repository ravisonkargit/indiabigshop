...
//Translate
var langDomain, domain_language_code, data_suggestion, productid;
                    ...
                    <div className="collection-banner p-left">
                      <div className="img-part">
                        <img
                          ...
                          alt={`${imgUrl}/images/lpnew/start_bidding.jpg`}
                        />
                      </div>
                    </div>
                  </a>
                    ...
                    <div className="collection-banner p-left">
                      <div className="img-part">
                        <img
                          ...
                          className="img-fluid blur-up lazyload bg-img"
                          alt={`${imgUrl}/images/lpnew/Sponsered_Products.png`}
                        />
                      </div>
                    </div>
                  </a>
                    ...
                    <div className="collection-banner p-left">
                      <div className="img-part">
                        <img
                          ...
                          className="img-fluid blur-up lazyload bg-img"
                          alt={`${imgUrl}/images/lpnew/EXIBITION_Final.jpg`}
                        />
                      </div>
                    </div>
                  </a>
