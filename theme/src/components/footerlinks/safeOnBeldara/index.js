...
class SafeOnBeldara extends Component {
  constructor() {
    super();
    this.state = {
      data: ""
...
<Breadcrumb title={'Stay Safe On Beldara'} metaDesc={this.state.data.desc1} metaKeyword={this.state.data.keyword} metaTitle={this.state.data.title}/>
...
export default connect(mapStateToProps)(SafeOnBeldara);
