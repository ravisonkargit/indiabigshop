...
class MediaScreenshotwithoutlink extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
...
const mapStateToProps = (state) => {
    return  state.MediaScreenshotwithoutlink
}

export default connect(mapStateToProps,{getAllMediaRelease})(MediaScreenshotwithoutlink);
